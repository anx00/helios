    ...
    def _reconstruct_official_obs(self, data: Dict) -> Optional[OfficialObs]:
        ...
        try:
            return OfficialObs(
                ...
                temp_f_low=data.get("temp_f_low"),
                temp_f_high=data.get("temp_f_high"),
                settlement_f_low=data.get("settlement_f_low"),
                settlement_f_high=data.get("settlement_f_high"),
                has_t_group=data.get("has_t_group", False),
